...
T = TypeVar("T", bound="PulsightInternalCoreUsecasesTraderDailyProfitListItem")


@_attrs_define
class PulsightInternalCoreUsecasesTraderDailyProfitListItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pulsight_internal_core_usecases_trader_daily_profit_list_item = cls(
        ...
        pulsight_internal_core_usecases_trader_daily_profit_list_item.additional_properties = d
        return pulsight_internal_core_usecases_trader_daily_profit_list_item
