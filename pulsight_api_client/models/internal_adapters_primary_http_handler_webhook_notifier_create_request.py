...
if TYPE_CHECKING:
    from ..models.internal_adapters_primary_http_handler_webhook_notifier_create_request_webhook_extra import (
        InternalAdaptersPrimaryHttpHandlerWebhookNotifierCreateRequestWebhookExtra,
    )


T = TypeVar("T", bound="InternalAdaptersPrimaryHttpHandlerWebhookNotifierCreateRequest")


@_attrs_define
class InternalAdaptersPrimaryHttpHandlerWebhookNotifierCreateRequest:
    """
    Attributes:
        ...
        webhook_extra (InternalAdaptersPrimaryHttpHandlerWebhookNotifierCreateRequestWebhookExtra | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if isinstance(_webhook_extra, Unset):
            ...
            webhook_extra = InternalAdaptersPrimaryHttpHandlerWebhookNotifierCreateRequestWebhookExtra.from_dict(
                _webhook_extra
            )
        ...
        internal_adapters_primary_http_handler_webhook_notifier_create_request = cls(
        ...
        internal_adapters_primary_http_handler_webhook_notifier_create_request.additional_properties = d
        return internal_adapters_primary_http_handler_webhook_notifier_create_request
