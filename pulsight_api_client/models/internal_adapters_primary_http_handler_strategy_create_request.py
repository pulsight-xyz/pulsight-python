...
T = TypeVar("T", bound="InternalAdaptersPrimaryHttpHandlerStrategyCreateRequest")


@_attrs_define
class InternalAdaptersPrimaryHttpHandlerStrategyCreateRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        internal_adapters_primary_http_handler_strategy_create_request = cls(
            def_=def_,
            description=description,
            name=name,
        )

        internal_adapters_primary_http_handler_strategy_create_request.additional_properties = d
        return internal_adapters_primary_http_handler_strategy_create_request
