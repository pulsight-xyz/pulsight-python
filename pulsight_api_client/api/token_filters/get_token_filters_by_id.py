...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/token-filters/{id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PulsightInternalCoreDomainTokenviewFilter.from_dict(
            response.json()
        )
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[InternalAdaptersPrimaryHttpHandlerErrorResponse | PulsightInternalCoreDomainTokenviewFilter]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        InternalAdaptersPrimaryHttpHandlerErrorResponse | PulsightInternalCoreDomainTokenviewFilter
    """
