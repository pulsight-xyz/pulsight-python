...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    InternalAdaptersPrimaryHttpHandlerErrorResponse
    | list[PulsightInternalCoreDomainApikeyKey]
    | None
):
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = PulsightInternalCoreDomainApikeyKey.from_dict(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[InternalAdaptersPrimaryHttpHandlerErrorResponse | list[PulsightInternalCoreDomainApikeyKey]]
    """
...
def sync(
    *,
    ...
    Returns:
        InternalAdaptersPrimaryHttpHandlerErrorResponse | list[PulsightInternalCoreDomainApikeyKey]
    """
