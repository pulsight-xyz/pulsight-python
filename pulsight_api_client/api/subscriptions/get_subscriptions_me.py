...
from ...models.pulsight_internal_core_ports_input_subscription_info import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PulsightInternalCorePortsInputSubscriptionInfo.from_dict(
            response.json()
        )
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[InternalAdaptersPrimaryHttpHandlerErrorResponse | PulsightInternalCorePortsInputSubscriptionInfo]
    """
...
def sync(
    *,
    ...
    Returns:
        InternalAdaptersPrimaryHttpHandlerErrorResponse | PulsightInternalCorePortsInputSubscriptionInfo
    """
